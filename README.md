...
| **Web dashboard** | Hourly snapshot on Aliyun `:8787/dashboard` (ops / exec views, answered + silent Q&A, 60-day calendar with day-level logo names + wallet types). Token via `DASHBOARD_TOKEN`. |
